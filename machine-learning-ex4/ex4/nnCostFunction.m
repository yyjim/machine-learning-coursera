...
for k = 1:num_labels
  _y = y == k;
  hk = H(:, k)';
  J += (-_y'*log(hk)') - (1-_y)'* log(1-hk)';
endfor
J = J / m;

% Regularization cost function
% Using 2:n to remove bais
n1 = rows(Theta1');
sum_theta1 = sum(((Theta1'.^2)(2:n1, :))(:)); % 
n2 = rows(Theta2');
sum_theta2 = sum(((Theta2'.^2)(2:n2, :))(:));
J += (lambda * (sum_theta1 + sum_theta2)) / (2 * m);
